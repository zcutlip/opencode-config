...
```json
{
  ...
  "body": "[Generated by AI]\n\nIssue description here with markdown..."
}
```

Both `title` and `body` fields must include the `[Generated by AI]` prefix for all write operations.
...
{
  "title": "[Generated by AI] Issue Title",
