#!/usr/bin/env python3
"""Fetch Magic Context release JSON from GitHub API.
...
API_BASE = "https://api.github.com/repos/cortexkit/magic-context/releases"
...
def fetch(url: str, count: int) -> None:
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "magic-context-release-notes/1.0",
        },
    )
    try:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch Magic Context releases as JSON",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--tag", type=str,
        help="Specific tag to fetch (e.g. v0.32.0)",
    )
